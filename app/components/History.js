...
const api =
  "http://locahost:1337/api/posts?filters[categories][name][$eq]=history&sort=publishedAt:desc&pagination[page]=1&pagination[pageSize]=4&populate=*";
...
export default async function Articles() {
  ...
  if (data.length === 0) {
    return (
      <h3 className="font-literata text-lg md:text-2xl my-20 text-zinc-500 mx-auto">
        Δεν υπάρχουν Άρθρα Ιστορία
      </h3>
    );
  }
